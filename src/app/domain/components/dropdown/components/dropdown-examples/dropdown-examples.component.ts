...
@Component({
    ...
    imports: [DAYDropdownComponent, DAYDropdownHeaderTmplDirective, DAYDropdownSelectionTmplDirective, DAYDropdownItemTmplDirective, DAYDropdownGroupTmplDirective, DAYTableComponent, DAYTableCellTmplDirective, DAYTableColumnComponent, DAYTableActionsTmplDirective, DAYToastTriggerDirective, DAYIconComponent, DAYToastComponent]
})
